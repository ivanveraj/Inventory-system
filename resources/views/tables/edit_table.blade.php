<x-modalB modalId="edit" title="Edicion de mesa ({{ $table->name }})" modalTitle="modalTitle">
    <form id="FormEdit" action="{{ route('table.update') }}" method="POST">
        @csrf
